...
/* Hero */
.hero {
    background: linear-gradient(135deg,#0B1F3A 0%,#2563EB 55%,#06B6D4 100%);
    padding: 28px 32px;
    border-radius: 18px;
...
/* KPI cards - explicit dark text fixes white-on-white issue */
...
/* Fallback selectors for Streamlit theme variations */
